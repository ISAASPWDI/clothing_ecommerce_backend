...
import { ProductRelationsOptions, RelationType } from "../../database/helpers/ProductRelationsHelper";
...
export class ProductRepositoryImpl implements ProductRepository {
    ...
    findProductsByRelation(
        ...
        return this.productDataSource.findProductsByRelation(filterData, page)
    }
